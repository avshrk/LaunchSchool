...
ar = []
ar << todo1 << todo2 << todo3

tlist = TodoList.new("Today's Todos")
tlist.add(ar)

fb = tlist.find_by_title('Buy milk')
puts fb

todo1.done!

tlist.mark_done('Clean room')

tlist.each { |e| puts e }
puts 'all done'
results = tlist.all_done
puts results
nr = tlist.all_not_done
puts 'all not done '
puts nr
